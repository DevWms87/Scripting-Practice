...
# This line is to combine the provider list as k-variable (for key) and ips list as v-variable (for value).  
# It also establishes that the key is a value since the ips addresses are values.
...
# This command is filling the list of dictionaries DNS_dictionaries keys and values from part 1.
for k,v in DNS_dictionary.items():
    DNS_dictionaries.extend([{"providers_name: " + k + ": " + "primary_server: " +v}])
